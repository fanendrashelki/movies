export const data = [
  {
    ...
    rating: "9.8",
    description:
      "Im Sol travels back in time to prevent the tragic fate of her favorite star, Ryu Sun Jae.",
  ...
  },
  {
    ...
    rating: "TBD",
    description:
      "A gripping tale of love, loss, and resilience set against the backdrop of a war-torn nation.",
